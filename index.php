...
<html class="no-js" lang="en">
    <head>
		...
		<meta name="keywords" content="Modutrade" />
		<meta name="description" content="">
		<meta name='copyright' content='Modutrade'>	
		
		<!-- Title Tag -->
        <title>Modutrade Inc</title>
										...
										<div class="collapse navbar-collapse">	
											<ul class="nav navbar-nav">
												<li class="active"><a href="#">Home<i class="fa fa-angle-down"></i></a>
													<ul class="drop-down">
														<li><a href="#">Multi Page<i class="fa fa-angle-right"></i></a>
															<ul class="drop-down sub-menu">
																<li><a href="index.html">Default Homepage</a></li>
																<li><a href="index2.html">Creative Homepage</a></li>
																<li><a href="index3.html">Animate Text Homepage</a></li>
															</ul>
														</li>
														<li><a href="#">One Page<i class="fa fa-angle-right"></i></a>
															<ul class="drop-down sub-menu">
																<li><a href="index4.html">Default Homepage</a></li>
																<li><a href="index5.html">Creative Homepage</a></li>
																<li><a href="index6.html">Animate Text Homepage</a></li>
															</ul>
														</li>
													</ul>
												</li>
												...
												<li><a href="#">services<i class="fa fa-angle-down"></i></a>
													<ul class="drop-down">
														...
														<li><a href="service-single-left.html">service Single Left</a></li>
														<li><a href="service-single.html">service Single Right</a></li>
														<li><a href="service-single-full.html">service Single Full Width</a></li>
													</ul>
												</li>
												<li><a href="#">Projects<i class="fa fa-angle-down"></i></a>
													<ul class="drop-down">
														<li><a href="projects-masonry.html">Projects Masonry</a></li>
														<li><a href="projects-3-column.html">Projects 3 Column</a></li>
														<li><a href="projects-2-column.html">Projects 2 Column</a></li>
												...
												<li><a href="#">Blogs<i class="fa fa-angle-down"></i></a>
													<ul class="drop-down">
														...
														<li><a href="blogs-grid-layout.html">Blogs Grid Layout</a></li>
														<li><a href="blog-single-left-sidebar.html">Blog Single - Left Sidebar</a></li>
														<li><a href="blog-single.html">Blog Single - Right Sidebar</a></li>
													</ul>
												</li>	
												<li class="mega-menu"><a href="contact.html">Shortcodes<i class="fa fa-angle-down"></i></a>
													<ul class="drop-down mega-inner">
														<li class="single-menu">
															<h4>Shortcode One</h4>
															<ul class="list-menu">
																<li><a href="hero-area.html"><span class="fa fa-sliders"></span>Hero Area</a></li>
																<li><a href="call-to-action.html"><span class="fa fa-phone"></span>Call To Action</a></li>
																<li><a href="progress-bars.html"><span class="fa fa-bars"></span>Progress Bars</a></li>
																<li><a href="tabs.html"><span class="fa fa-toggle-on"></span>Tabs</a></li>
																<li><a href="counter.html"><span class="fa fa-clock-o"></span>Counter</a></li>
																<li><a href="team.html"><span class="fa fa-sliders"></span>Team</a></li>
															</ul>
														</li>
														<li class="single-menu">
															<h4>Shortcode Two</h4>
															<ul class="list-menu">
																...
																<li><a href="parallax.html"><span class="fa fa-star"></span>Parallax</a></li>
																<li><a href="buttons.html"><span class="fa fa-toggle-on"></span>Buttons</a></li>
																<li><a href="features.html"><span class="fa fa-list-alt"></span>Features</a></li>
																<li><a href="font-icon.html"><span class="fa fa-font-awesome"></span>Font Icon</a></li>
																<li><a href="clients.html"><span class="fa fa-user"></span>Clients</a></li>
															</ul>
														</li>
							...
							<div class="row">
								<div class="col-md-7 col-sm-12 col-xs-12">
									...
									<div class="slide-text">
										<h1><span class="short">You are entire</span>Creative Business</h1>
										<p>welcome to modutrade, Contrary to popular belief. Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old .</p>
										<div class="slide-btn">	
											<a href="https://www.youtube.com/watch?v=FZQPhrdKjow" class="btn primary video-play video-popup mfp-fade">Play Video<i class="fa fa-play"></i>
						...
						<div class="container">
							<div class="row">
								<div class="col-md-7 col-sm-12 col-xs-12">
									<!-- Slider Text -->
									<div class="slide-text">
										<h1><span class="short">You are entire</span>Modutrade</h1>
										<p>welcome to modutrade, Contrary to popular belief. Lorem Ipsum is not simply random text. It has roots in a piece of classical Latin literature from 45 BC, making it over 2000 years old .</p>
										<div class="slide-btn">	
											<a href="#projects" class="btn primary">Our Projects<i class="fa fa-long-arrow-down"></i></a>
										</div>
									</div>
									<!--/ End SLider Text -->
								</div>
					...
					<div class="row fix">
						...
						<div class="col-md-4 col-sm-12 col-xs-12 fix">
							<div class="why-video">
								...
								<!--/ End Video Animation -->
								<!-- Promo Video -->
								<div class="video"><a href="https://www.youtube.com/watch?v=E-2ocmhF6TA" class="btn video-play video-popup mfp-fade"><i class="fa fa-play"></i></a></div>
								<!--/ End Promo Video -->
							</div>
						</div>					
					</div>
						...
						<div class="col-md-12 col-sm-12 col-xs-12">
							...
							<div id="loadMore" class="cbp-l-loadMore-button">
								<div class="load-button">
									<a href="more-project/project.html" class="cbp-l-loadMore-link btn primary" rel="nofollow">
					...
					<div class="row">
						<div class="col-md-8 col-md-offset-2 col-sm-12 col-xs-12">
							...
							<div class="newslatter-inner">
								<div class="checkbox">
									<label class="checkbox-inline" for="updates"><input name="updates" id="updates" type="checkbox"> About updates</label>
									<label class="checkbox-inline" for="news"><input name="news" id="news" type="checkbox"> Weekly news</label>
									<label class="checkbox-inline" for="reseller"><input name="reseller" id="reseller" type="checkbox">Monthly Digest</label>
								</div>	
									...
									<div class="single-blog single-slider">
										<div class="blog-post">
											...
											<div class="blog-info">
												...
												<div class="meta">
													<span><i class="fa fa-list"></i><a href="#">Finance</a></span>
													<span><i class="fa fa-calendar-o"></i>02 July, 2017</span>
													<span><i class="fa fa-heart-o"></i><a href="#">99</a></span>
												</div>
												<p>Mirum est notare quam littera gothica, quam nunc putamus parum claram, anteposuerit litterarum formas humanitatis per seacula</p>
											</div>
									...
									<div class="single-blog single-slider">
										<div class="blog-post">
											...
											<div class="blog-info">
												...
												<div class="meta">
													<span><i class="fa fa-list"></i><a href="#">Resource</a></span>
							...
							<div class="col-md-3 col-sm-6 col-xs-12">
								...
								<div class="single-widget twitter">
									...
									<div class="single-tweet">
										...
										<p><a href="#">@modutrade</a> Mirum est notare quam littera gothica, quam nunc</p>
										<span>4 Minutes Ago</span>
									</div>
									<div class="single-tweet">
										<i class="fa fa-twitter"></i>
										<p><a href="#">@modutrade</a> claram, anteposuerit litterarum</p>
										<span>3 Hourse Ago</span>
									</div>
									<div class="single-tweet">
										<i class="fa fa-twitter"></i>
										<p><a href="#">@modutrade</a> per seacula quarta decima et quinta decima.</p>
					...
					<div class="container">
						<div class="row">
							<div class="col-md-12 col-sm-12 col-xs-12">
								<!-- copyright -->
								<div class="copyright">
									<p>&copy; 2017 All Right Reserved.  Design & Developed By <a href="#">modutrade</a></p>
								</div>
								<!--/ End Copyright -->
							</div>
						</div>
